    ...
    <SlideUpWrapper>
      <nav className="bg-cyan-300/10 text-white px-4 sm:px-8 py-2 backdrop-blur-lg sticky top-0 z-50">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div>
            <img src={img} alt="Sign" className="w-44 h-10 sm:w-60 sm:h-12 rounded-full" />
          </div>

          {/* Desktop Nav Links */}
          <div className="hidden md:flex space-x-8 items-center">
            <a href="#" className="hover:text-cyan-400 font-bold font-lucid">Home</a>
            <a href="#about" className="hover:text-cyan-400 font-bold font-sans">About</a>
            <a href="#contact" className="hover:text-cyan-400 font-bold font-sans">Contact</a>
            <a
        ...
        {isOpen && (
          <div className="flex flex-col space-y-4 mt-4 md:hidden items-center">
            <a href="#" className="hover:text-cyan-400 font-bold">Home</a>
            <a href="#about" className="hover:text-cyan-400 font-bold">About</a>
            <a href="#contact" className="hover:text-cyan-400 font-bold">Contact</a>
            <a
